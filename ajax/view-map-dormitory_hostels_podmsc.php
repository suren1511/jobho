...
if (CModule::IncludeModule("iblock")) {
    ...
    $arSelect = Array("IBLOCK_ID", "ID", "NAME", "DETAIL_PAGE_URL", "PROPERTY_metro", "PROPERTY_ulica", "PROPERTY_mskokruga", "PROPERTY_ulica", "PROPERTY_mskokruga", "PROPERTY_yandexmap", "PROPERTY_oblrayoni", "PROPERTY_oblnapr", "PROPERTY_group");
