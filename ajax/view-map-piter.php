...
if (CModule::IncludeModule("iblock")) {
	...
	$arSelect = Array("IBLOCK_ID", "ID", "PROPERTY_TIPOBSHEJITIYA", "NAME", "DETAIL_PAGE_URL", "PROPERTY_metro", "PROPERTY_ulica", "PROPERTY_napr", "PROPERTY_yandexmap", "PROPERTY_napr", "PROPERTY_spbokruga", "PROPERTY_group");
...
<?$i=1; $j=1; $k=1;
    foreach($arResult["ITEMS"] as $arElement):
		...
		if (strpos($_SERVER["HTTP_REFERER"],'hostel_for_child/hostel_in_spb/')) {
			$bool = false;
			if($arElement['PROPERTY_TIPOBSHEJITIYA_ENUM_ID'] == 2325)
				$bool = true;
		}
		if (strpos($_SERVER["HTTP_REFERER"],'hostel_for_ck/hostel_in_spb/')) {
			$bool = false;
			if($arElement['PROPERTY_TIPOBSHEJITIYA_ENUM_ID'] == 2326)
				$bool = true;
		}
