...
if (CModule::IncludeModule("iblock")) {
	...
	$arSelect = Array("IBLOCK_ID", "ID", "NAME", "DETAIL_PAGE_URL", "PROPERTY_metro", "PROPERTY_rayonmoskvi", "PROPERTY_mskokruga", "PROPERTY_ulica", "PROPERTY_napr", "PROPERTY_yandexmap", "PROPERTY_oblrayoni", "PROPERTY_oblnapr", "PROPERTY_group");
	$arFilter = Array("IBLOCK_ID"=>3, "ACTIVE"=>"Y", 'PROPERTY_HOSTEL' => 2311);
