...
<?
$show = true;
if(strpos($_SERVER["HTTP_REFERER"],'hostel_for_ck/dormitory_suburbs/')){
	if (CModule::IncludeModule("iblock")) {

		$arSelect = Array("IBLOCK_ID", "ID", "PROPERTY_TIPOBSHEJITIYA", "NAME", "DETAIL_PAGE_URL", "PROPERTY_metro", "PROPERTY_ulica", "PROPERTY_mskokruga", "PROPERTY_ulica", "PROPERTY_mskokruga", "PROPERTY_yandexmap", "PROPERTY_oblrayoni", "PROPERTY_oblnapr", "PROPERTY_group");
...
<? $i=1; $j=1; $k=1;
        foreach($arResult["ITEMS"] as $arElement):
			...
			if (strpos($_SERVER["HTTP_REFERER"],'hostel_for_child/dormitory_suburbs/')) {				
                $boolC = false;
				$bool = true;
