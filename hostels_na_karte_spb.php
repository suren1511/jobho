...
$APPLICATION->SetPageProperty("description", "Компания «ДжобХостел» занимается поиском и арендой хостелов для рабочих. В данном разделе вы можете посмотреть адреса доступных общежитий на карте Санкт-Петербурга.");
...
<div class="dormitory list" id="oshegitiya_map">
    <div>
		...
		$arrrFilter['PROPERTY_HOSTEL'] = 2321;
        $APPLICATION->IncludeComponent(
            "alma:catalog.section.prop",
            "only_map_piter_hostels",
            array(
