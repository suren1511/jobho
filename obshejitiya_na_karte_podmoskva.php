...
$APPLICATION->SetPageProperty("description", "Компания «ДжобХостел» занимается поиском и арендой общежитий для рабочих. В данном разделе вы можете посмотреть адреса доступных общежитий на карте Москвы. ");
