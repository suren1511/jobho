          ...
          <div class="form-groups">
            <div class="form-group">
              ...
              <div class="input-group">
                <input class="form-control" type="text" id="i1" value="<?= $resumeData["PROPERTY_FIRST_NAME_VALUE"] ? $resumeData["PROPERTY_FIRST_NAME_VALUE"] : '' ?>" name="FIRST_NAME" placeholder="Ваше имя">
              </div>
            </div>
            <div class="form-group">
              <label for="i2" class="required">Фамилия</label>
              <div class="input-group">
                <input class="form-control" type="text" id="i2" value="<?= $resumeData["PROPERTY_LAST_NAME_VALUE"] ? $resumeData["PROPERTY_LAST_NAME_VALUE"] : '' ?>" name="LAST_NAME" data-req="1" placeholder="Ваша фамилия">
              </div>
            </div>
            <div class="form-group">
              <label for="i3" class="required">Моб. телефон</label>
              <div class="input-group">
                <input class="form-control" type="text" id="i3" value="<?= $resumeData["PROPERTY_PHONE_VALUE"] ? $resumeData["PROPERTY_PHONE_VALUE"] : '' ?>" name="PHONE" data-req="1" placeholder="+ 7 955 555 55 55">
              </div>
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
              ...
              <div class="input-group">
                <input class="form-control" type="text" id="i8" value="<?= $resumeData["PROPERTY_WORK_ACCESS_VALUE"] ? $resumeData["PROPERTY_WORK_ACCESS_VALUE"] : '' ?>" name="WORK_ACCESS" data-req="1" placeholder="Страна">
              </div>
            </div>
            <div class="form-group">
              <label for="i9" class="required">Регион проживания</label>
              <div class="input-group">
                <input class="form-control" type="text" id="i9" value="<?= $resumeData["PROPERTY_REGION_VALUE"] ? $resumeData["PROPERTY_REGION_VALUE"] : '' ?>" name="REGION" data-req="1" placeholder="Ваш регион">
              </div>
            </div>
            <div class="form-group">
