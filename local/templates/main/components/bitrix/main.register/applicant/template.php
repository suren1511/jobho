...
<div class="bx-auth-reg">
    ...
    <?else:?>
        ...
        <form method="post" action="<?=POST_FORM_ACTION_URI?>" name="regform" enctype="multipart/form-data">
            ...
            ?>
                <input type="radio" value="IN_SEARCH" checked name="CHECK"><span>Ищу жильё</span>
                <input type="radio" value="RENT_OUT" name="CHECK"><span>Сдам жильё</span>
                ...
                <?foreach ($arResult["SHOW_FIELDS"] as $FIELD):?>
                    ...
                    <?else:?>
                        <div class="popup__input">
                            <span><?=GetMessage("REGISTER_FIELD_".$FIELD)?>:<?if ($arResult["REQUIRED_FIELDS_FLAGS"][$FIELD] == "Y"):?><i class="starrequired">*</i></span><?endif?>
                            <?
                                switch ($FIELD)
                                {
                                    case "PASSWORD":
                ...
                <?if($arResult["USER_PROPERTIES"]["SHOW"] == "Y"):?>
                    <div class="popup__input"><hr><?=strlen(trim($arParams["USER_PROPERTY_NAME"])) > 0 ? $arParams["USER_PROPERTY_NAME"] : GetMessage("USER_TYPE_EDIT_TAB")?></div>
                    <?foreach ($arResult["USER_PROPERTIES"]["DATA"] as $FIELD_NAME => $arUserField):?>
                        <div class="popup__input"><?=$arUserField["EDIT_FORM_LABEL"]?>:<?if ($arUserField["MANDATORY"]=="Y"):?><span class="starrequired">*</span><?endif;?>
                                <?$APPLICATION->IncludeComponent(
                ...
                ?>
                    ...
                    <input type="submit" name="register_submit_button" class="btn btn--blue" value="<?=GetMessage("AUTH_REGISTER")?>" />
