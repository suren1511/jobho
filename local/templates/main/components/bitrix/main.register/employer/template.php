    ...
    <?else:?>
        ...
        <form method="post" action="<?=POST_FORM_ACTION_URI?>" name="regform" enctype="multipart/form-data">
            ...
            <?if($arResult["USER_PROPERTIES"]["SHOW"] == "Y"):?>
                <hr><?=strlen(trim($arParams["USER_PROPERTY_NAME"])) > 0 ? $arParams["USER_PROPERTY_NAME"] : GetMessage("USER_TYPE_EDIT_TAB")?>
                <?foreach ($arResult["USER_PROPERTIES"]["DATA"] as $FIELD_NAME => $arUserField):?>
                    <div class="popup__input"><span><?=$arUserField["EDIT_FORM_LABEL"]?>:</span><?if ($arUserField["MANDATORY"]=="Y"):?><i class="starrequired">*</i><?endif;?>
                        <?$APPLICATION->IncludeComponent(
