...
$MESS["REGISTER_FIELD_CONFIRM_PASSWORD"] = "Повторите пароля";
...
$MESS["PERSONAL_PRIVACY"] = "Я согласен с <a href=\"#\">политикой</a> обработки персональных данных";
?>