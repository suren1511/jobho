                    ...
                    <div class="form__registration-type">
                        <div class="form-group">
                            <div class="form-group-mini">
                                <input type="radio" class="styled align-top" id="i21" value="1" name="UF_USER_TYPE" data-id="i21" data-type="client" checked>
                                <label for="i21-c">Соискатель <span>Ищу работу</span></label>
                            </div>
                            <div class="form-group-mini">
                                <input type="radio" class="styled align-top" id="i22" value="2" name="UF_USER_TYPE" data-id="i22" data-type="company">
                                <label for="i22-c">Работодатель <span>Ищу сотрудников</span></label>
                            </div>
                            <div class="form-group-mini">
                                <input type="radio" class="styled align-top" id="i23" value="3" name="UF_USER_TYPE" data-id="i23" data-type="company">
                                <label for="i23-c">Арендодатель <span>Сдаю жилье</span></label>
                            </div>
                            <div class="form-group-mini">
                                <input type="radio" class="styled align-top" id="i24" value="4" name="UF_USER_TYPE" data-id="i24" data-type="client">
            ...
            <div class="form__auth">
                ...
                <div class="form__auth-column">
                    <div class="form__registration-type">
                        <div class="form-group">
                            <div class="form-group-mini">
                                <input type="radio" class="styled align-top" id="i21-c" value="1" name="UF_USER_TYPE" data-id="i21" data-type="client" checked>
                                <label for="i21-c">Соискатель <span>Ищу работу</span></label>
                            </div>
                            <div class="form-group-mini">
                                <input type="radio" class="styled align-top" id="i22-c" value="2" name="UF_USER_TYPE" data-id="i22" data-type="company">
                                <label for="i22-c">Работодатель <span>Ищу сотрудников</span></label>
                            </div>
                            <div class="form-group-mini">
                                <input type="radio" class="styled align-top" id="i23-c" value="3" name="UF_USER_TYPE" data-id="i23" data-type="company">
                                <label for="i23-c">Арендодатель <span>Сдаю жилье</span></label>
                            </div>
                            <div class="form-group-mini">
                                <input type="radio" class="styled align-top" id="i24-c" value="4" name="UF_USER_TYPE" data-id="i24" data-type="client">
                                <label for="i24-c">Арендатор <span>Ищу жилье</span></label>
                            </div>
                        </div>
                    </div>
