...
$controlName = "PROPERTY[".$arParams['INPUT_NAME']."]";
...
{
?>
<a href="javascript:void(0);" id="file-selectdialogswitcher-<?=$uid?>" class="styled-number" <?
	?>onclick="BX.onCustomEvent(this.parentNode, 'BFileDLoadFormController');return false;"><span class="styled-number__desc"><?
