...
<?
$templaite='amt_vacanci';
$CURRENT_DIR=$APPLICATION->GetCurPage();
...
if ($arCurDir[3]=='arhiv_vac.php'){
  $arrFilterRab=array();
  $arrFilterRab = array(
    'PROPERTY_USER'=>$USER->GetID(),
    '!PROPERTY_ARHIV'=> false
  );
}
if ($arCurDir[3]=='template_vac.php'){
  $templaite='amt_vacanci_templ';
  $arrFilterRab=array();
  $arrFilterRab = array(
    'PROPERTY_USER'=>$USER->GetID(),
    '!PROPERTY_SABLON'=> false
  );
}

if ($arCurDir[2]=='manager'){
  $arrFilterRab=array();
